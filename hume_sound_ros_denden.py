...
import websockets
#from websockets.legacy.typing import StreamSocket
...
audio_buffer = AudioBuffer(
    ...
    topic_name='/audio',
    #topic_name = '/audio/audio', #学科PCのマイクを使う場合
    window_size=2,
    auto_start=True)
...
async def send_audio():
    ...
    #except KeyboardInterrupt:
        #play_process = Popen(["playsound", "ガチャ.mp3"], stdout=PIPE, stderr=PIPE)
...
#rospy.init_node('eye_status_publisher', anonymous=True)
#eye_status_publisher.publish(UInt16(data=0)) 


playsound("ペレっペレ.ガチャ.mp3")
        # Publisherを作成
#eye_status_publisher = rospy.Publisher('/eye_status', UInt16, queue_size=1)
